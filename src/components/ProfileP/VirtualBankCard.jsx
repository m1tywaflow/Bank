    ...
    <div className="flex flex-col items-center gap-4">
      ...
      >
        ...
        >
          {/* Front */}
          <div
            className="absolute w-full h-full rounded-2xl p-6 bg-gradient-to-br from-gray-900 via-black to-[#1f1f2e] text-white"
            style={{ backfaceVisibility: "hidden" }}
          >
            <div className="flex justify-between items-center mb-8">
              <span className="text-lg font-bold flex items-center">
            ...
            <div className="flex justify-between text-sm">
              <div>
                <p className="uppercase text-gray-400 text-xs">Card Holder</p>
                <p className="font-semibold">{card.holder}</p>
              </div>
              <div>
                <p className="uppercase text-gray-400 text-xs">Expires</p>
                <p className="font-semibold">{card.expiry}</p>
              </div>
            </div>
          ...
          {/* Back */}
          <div
            className="absolute w-full h-full bg-gradient-to-br from-gray-800 via-black to-[#1f1f2e] text-white rounded-2xl p-6"
            style={{
              backfaceVisibility: "hidden",
              transform: "rotateY(180deg)",
            }}
          >
            <div className="bg-gray-700 h-12 mb-6 rounded"></div>
            <div className="flex justify-end items-center h-full">
              <div className="bg-white text-black px-4 py-2 rounded-md shadow">
                CVV: {card.cvv}
              </div>
            </div>
          </div>
      ...
      <button
        onClick={handleRefresh}
        className="mt-2 px-5 py-2 rounded-full bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-bold hover:opacity-90 transition"
      >
        Generate New Card
      </button>
    </div>
